...
class DataMath23k():
    def __init__(self, flag=False):
        if flag == False:
            ...
            # print(os.getcwd())
            self.data_dict = read_data_json("../data/math23k_dolphin.json")
    ...
    def process_ans(self, ans):
        try:
            ...
            if '%' in ans:
                ...
                e_2 = ans.find(')', s_2)
                num_2 = ans[s_2+1:e_2]
                ans = float(num_pre)+float(num_1)/float(num_2) #WRONG TO BE CHANGED
                return str(ans)
    ...
    def process_single_num(self, ans):
        try:
            ...
            if '%' in ans:
                ...
                e_2 = ans.find(')', e_1)
                num_2 = ans[e_1+1:e_2]
                ans = float(num_pre)+float(num_1)/float(num_2) #WRONG TO be CHNaged
                return str(ans)
...
class Word2vec:
    def __init__(self, data_23k, flag = False):
...
class DataLoader():
    def __init__(self,args=None):
        ...
        self.word2vec = Word2vec(self.data_23k, True)
